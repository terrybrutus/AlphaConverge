...
// ---------------------------------------------------------------------------
// Sample preview universe (frontend mirror of the backend seed).
//
// Every entry is flagged `sample: true`. These are ILLUSTRATIVE inputs that
// exercise the convergence engine so the UI is fully navigable before live
// data providers are wired. They are NOT market truth. See DATA.md.
//
// Once the backend is populated from real HTTP-outcall sources, the app reads
// the universe from the canister and this file is only a fallback.
// ---------------------------------------------------------------------------
export const SAMPLE_UNIVERSE: TickerRaw[] = [
  {
    symbol: "ACME",
    name: "Acme Robotics",
    sector: "Industrials",
    price: 6.94,
    priceHistory: [
      22.0, 19.5, 17.0, 14.2, 11.8, 9.9, 8.4, 7.1, 6.2, 5.4, 4.9, 4.44, 4.6,
      4.9, 5.3, 5.1, 5.6, 6.0, 5.8, 6.3, 6.7, 6.5, 6.8, 6.94,
    ],
    pctAbove52wLow: 11.0,
  ...
  },
  {
    ...
    price: 2.18,
    priceHistory: [
      9.8, 8.5, 7.2, 6.0, 4.9, 3.8, 3.0, 2.4, 2.0, 1.7, 1.55, 1.62, 1.7, 1.8,
      1.74, 1.9, 2.0, 1.95, 2.05, 2.1, 2.0, 2.12, 2.15, 2.18,
    ],
    pctAbove52wLow: 40.0,
  ...
  },
  {
    ...
    price: 18.4,
    priceHistory: [
      31.0, 28.5, 25.0, 22.4, 20.1, 18.0, 16.5, 15.2, 14.8, 15.4, 16.0, 15.6,
      16.4, 17.0, 16.6, 17.4, 17.0, 17.8, 18.2, 17.6, 18.0, 18.6, 18.1, 18.4,
    ],
    pctAbove52wLow: 24.0,
  ...
  },
  {
    ...
    price: 41.2,
    priceHistory: [
      18.0, 19.5, 21.0, 23.4, 22.0, 24.5, 26.0, 28.4, 27.0, 30.0, 32.5, 31.0,
      34.0, 36.5, 35.0, 37.5, 39.0, 38.0, 40.0, 41.5, 40.2, 41.8, 40.9, 41.2,
    ],
  ...
  },
  {
    ...
    price: 12.05,
    priceHistory: [
      14.0, 13.6, 14.2, 13.8, 14.1, 13.7, 14.0, 13.5, 13.9, 13.4, 13.8, 13.2,
      13.6, 13.0, 13.4, 12.8, 13.1, 12.6, 12.9, 12.4, 12.7, 12.2, 12.3, 12.05,
    ],
    pctAbove52wLow: 6.0,
  ...
  },
  {
    ...
    price: 3.05,
    priceHistory: [
      12.0, 10.5, 8.8, 7.0, 5.5, 4.2, 3.3, 2.7, 2.3, 2.1, 2.0, 2.15, 2.3, 2.2,
      2.45, 2.6, 2.5, 2.7, 2.85, 2.75, 2.9, 3.0, 2.95, 3.05,
    ],
    pctAbove52wLow: 52.0,
  ...
  },
  {
    ...
    price: 27.3,
    priceHistory: [
      44.0, 41.0, 38.5, 35.0, 32.4, 30.1, 28.0, 26.5, 25.8, 26.4, 25.9, 26.6,
      25.7, 26.8, 26.0, 27.0, 26.4, 27.2, 26.6, 27.4, 26.9, 27.5, 27.0, 27.3,
    ],
    pctAbove52wLow: 9.0,
